...
work_dir=/home/zhoushiqi/workplace/apr/data/evaluate_results/deepseek
pname=baseline_1.2_OnlyBuggycode
datas_path=/home/zhoushiqi/workplace/apr/data/df4_process_data/one_function/1.2.jsonl
prompt_path=/home/zhoushiqi/workplace/apr/src/prompts/template_3.txt
N=10
num_per_iter=10
T=1
...
for ((i = 0; i < $gpu_num; i++)); do
  ...
  ((index++))
  (
    CUDA_VISIBLE_DEVICES=$gpu python /home/zhoushiqi/workplace/apr/src/code/evaluate.py --model_id ${model} \
