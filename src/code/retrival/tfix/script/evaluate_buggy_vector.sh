...
embedding_model=/home/zhoushiqi/workplace/model/st-codesearch-distilroberta-base
work_dir=/home/zhoushiqi/workplace/apr/data/evaluate_results/retrieval/deepseek/tfix
pname=buggy_vector_sroberta_CaderPrompt_sm
datas_path=/home/zhoushiqi/workplace/apr/data/tfix/data/test_data_clean_sm.json
codebase_path=/home/zhoushiqi/workplace/apr/data/tfix/data/train_data_clean_sm.json
vector_path=/home/zhoushiqi/workplace/apr/data/vectors/tfix_clean_sm_sroberta.jsonl
num_example=1
N=10
num_per_iter=10
T=1
...
#   ((index++))
#   (
#     CUDA_VISIBLE_DEVICES=$gpu python /home/zhoushiqi/workplace/apr/src/code/retrival/tfix/evaluate_vector.py --model_id ${model} \
#       --num_gpus 1\
#       --dest_path ${dest_dir}/${i}.jsonl --datas_path ${datas_path} --N $N --num_per_iter $num_per_iter --temperature $T\
#       --codebase_path ${codebase_path} --num_example ${num_example} --num_gpu ${gpu} --embedding_model $embedding_model\
...
# bash /home/zhoushiqi/workplace/apr/src/code/retrival/tfix/script/evaluate_buggy_vector2.sh