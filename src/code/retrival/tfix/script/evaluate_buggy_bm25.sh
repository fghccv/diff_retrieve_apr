...
pname=buggy_bm25_CaderPrompt_sm
...
#   ((index++))
#   (
#     CUDA_VISIBLE_DEVICES=$gpu python /home/zhoushiqi/workplace/apr/src/code/retrival/tfix/evaluate_bm25.py --model_id ${model} \
#       --num_gpus 1\
#       --dest_path ${dest_dir}/${i}.jsonl --datas_path ${datas_path} --N $N --num_per_iter $num_per_iter --temperature $T\
#       --codebase_path ${codebase_path} --num_example ${num_example} --num_gpu ${gpu}
#   ) &
