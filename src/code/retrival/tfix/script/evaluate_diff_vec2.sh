...
pname=diff_vec_codet5p_round1_vec_sroberta
result_path=/home/zhoushiqi/workplace/apr/data/evaluate_results/retrieval/deepseek/tfix/buggy_vector_sroberta_CaderPrompt_sm_N10_T1_k1_result.jsonl
