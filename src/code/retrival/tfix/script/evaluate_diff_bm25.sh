...
pname=diff_bm25_round1_bm25
result_path=/home/zhoushiqi/workplace/apr/data/evaluate_results/retrieval/deepseek/tfix/buggy_bm25_CaderPrompt_sm_N10_T1_k1_result.jsonl
...
#   ((index++))
#   (
#     CUDA_VISIBLE_DEVICES=$gpu python /home/zhoushiqi/workplace/apr/src/code/retrival/tfix/evaluate_diff_bm25.py --model_id ${model} \
