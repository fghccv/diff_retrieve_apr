...
#SBATCH -o /home/zhoushiqi/workplace/apr/src/code/retrival/script/log/evaluate.out                           # 屏幕上的输出文件重定向到 test.out
#SBATCH -e /home/zhoushiqi/workplace/apr/src/code/retrival/script/log/evaluate.err
...
pname=baseline_1.2_bm25_k1_add_report
...
for ((i = 0; i < $gpu_num; i++)); do
  ...
  ((index++))
  (
    CUDA_VISIBLE_DEVICES=$gpu python /home/zhoushiqi/workplace/apr/src/code/retrival/evaluate_bm25.py --model_id ${model} \
      ...
      --codebase_path ${codebase_path} --num_example ${num_example}
  ) &
