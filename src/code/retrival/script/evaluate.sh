...
#   ((index++))
#   (
#     CUDA_VISIBLE_DEVICES=$gpu python /home/zhoushiqi/workplace/apr/src/code/retrival/evaluate_random.py --model_id ${model} \
...
bash /home/zhoushiqi/workplace/apr/src/code/retrival/script/evaluate_diff_bm25.sh